export default function Navbar({ first_name, last_name }) {
  return (
    <nav className="flex justify-between items-center px-20 py-8 border-b border-b-[rgb(30,30,33)]">
      ...
      <ul className="font-jetbrains-mono text-[13px] flex justify-center items-center gap-9 text-[rgb(134,134,139)]">
